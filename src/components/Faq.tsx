...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "All of them. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas cupiditate laboriosam fugiat.",
  },
  ...
  return (
    <Container>
      <div className=" divide-y divide-gray-900/10">
        <p>
          <span className="text-2xl font-bold leading-10 tracking-tight">
            Have a question?
          </span>{" "}
          <br />
