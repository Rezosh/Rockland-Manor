...
const IndependentCarePage = () => {
  return (
    <>
      ...
      <div className="mx-auto flex max-w-5xl items-center bg-cream">
        <Image
        ...
        <div className="p-12 text-center lg:text-left">
          ...
          <p>
            Ready to experience the comfort and convenience of independent
            living at Rockland Manor? Schedule a complimentary visit to see our
            community and learn more about our amenities and services. Join our
            vibrant community today and start living your best life!
          </p>
          <Link
            href="/contact"
